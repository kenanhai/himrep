...
{\bfseries H\+E\+L\+P} format\+: \mbox{[}help\mbox{]} action\+: it prints the available commands.

{\bfseries D\+U\+M\+P\+\_\+\+S\+I\+F\+T} format\+: \mbox{[}dump\mbox{]} \char`\"{}a\char`\"{} action\+: starts to dump local descriptors that can be used for dictionary learning. \char`\"{}a\char`\"{} is an optional parameters that stands for \char`\"{}append\char`\"{} in case you want to keep old descriptors previously dumped.

{\bfseries D\+I\+C\+T\+I\+O\+N\+A\+R\+Y\+\_\+\+L\+E\+A\+R\+N\+I\+N\+G} format\+: \mbox{[}learn\mbox{]} $<$dictionary\+Size$>$ \char`\"{}use\+P\+C\+A\char`\"{} $<$dim\+P\+C\+A$>$ action\+: starts to learn a dictionary from previously dumped local descriptors. $<$dictionary\+Size$>$ is the number of atoms of the dictionary, \char`\"{}use\+P\+C\+A\char`\"{} performs standard P\+C\+A analysis on low-\/level descriptors before the encoding and $<$dim\+P\+C\+A$>$ indicates the number of relevant eigenvectors that you want use for the projection.\hypertarget{group__icub__sparseCoder_lib_sec}{}\subsection{Libraries}\label{group__icub__sparseCoder_lib_sec}

\begin{DoxyItemize}
\item Y\+A\+R\+P libraries.
\item Open\+C\+V 2.\+2 libraries.
